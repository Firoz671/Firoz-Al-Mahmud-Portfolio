...
const StatCard = ({ icon: Icon, number, suffix, label, description, delay }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-white polished-card p-8 transition-all duration-500 ease-out group relative overflow-hidden flex flex-col items-start hover:bg-slate-900 hover:text-white"
        >
            <div className={`w-12 h-12 flex items-center justify-center mb-6 text-slate-900 transition-transform duration-500 ease-out group-hover:scale-110 group-hover:rotate-3 group-hover:text-white relative z-10`}>
                <Icon size={32} strokeWidth={1.5} />
            </div>

            <div className="relative z-10 w-full" ref={nodeRef}>
                <div className="flex items-baseline gap-1 mb-4 border-b border-slate-200 group-hover:border-white/20 pb-4 transition-colors duration-500">
                    <span className="text-5xl md:text-6xl font-bold text-slate-900 font-heading tracking-tighter group-hover:text-white transition-colors duration-500">
                        {count}
                    </span>
                    <span className={`text-3xl font-bold text-slate-900 group-hover:text-white transition-colors duration-500`}>{suffix}</span>
                </div>
...
const Impact = () => {
    const calendarTheme = {
        light: ['#f8fafc', '#e2e8f0', '#cbd5e1', '#94a3b8', '#1e293b']
    };
    ...
    return (
        <section id="impact" className="py-24 relative overflow-hidden bg-[#F4F4F1] transition-colors duration-500 border-t border-slate-200 border-b">
            ...
            <div className="w-11/12 max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                >
                    <span className="inline-block py-1 px-4 text-slate-900 font-bold tracking-[0.2em] text-xs uppercase mb-6 border-b border-slate-300">Developer Impact</span>
                ...
                <motion.div
                    ...
                    className="bg-white p-8 md:p-12 polished-card relative overflow-hidden flex flex-col items-center justify-center max-w-5xl mx-auto group"
                >
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10 w-full border-b border-slate-200 pl-4 md:pl-0 pb-8">
                        <div className="flex items-center gap-4">
                            <div className="text-slate-900 transition-transform duration-500 ease-out group-hover:rotate-12 group-hover:scale-110 group-hover:-translate-y-1">
